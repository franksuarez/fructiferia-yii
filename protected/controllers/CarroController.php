...
class CarroController extends Controller {
    ...
    public function actionActualizarProductosCarro() {
        ...
        Yii::app()->user->setFlash('productosCarroActualizados', "Su carro de compras se ha actualizado correctamente.");
    ...
    public function actionEliminarProductoCarro($id) {
        ...
        Yii::app()->user->setFlash('productoCarroEliminado', "El producto se ha quitado de su carro correctamente.");
    ...
    public function actionFinalizarPedido() {
        ...
        $this->render('finalizarPedido', array('formasPago' => $formasPago)
        );
    }
