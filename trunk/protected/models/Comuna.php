 ...
 * @property string $comuna_descripcion
 *
...
class Comuna extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('comuna_nombre, comuna_descripcion', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('comuna_id, comuna_nombre, comuna_descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'direccions' => array(self::HAS_MANY, 'Direccion', 'comuna_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'comuna_descripcion' => 'Comuna Descripcion',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('comuna_descripcion',$this->comuna_descripcion,true);
