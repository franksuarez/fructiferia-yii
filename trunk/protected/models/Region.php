...
class Region extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('region_numero', 'numerical', 'integerOnly'=>true),
			array('region_nombre, region_descripcion', 'length', 'max'=>255),
			array('region_numero_romano', 'length', 'max'=>10),
	...
	public function relations()
	{
		...
		return array(
			'provincias' => array(self::HAS_MANY, 'Provincia', 'region_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'region_numero' => 'Region Numero',
			'region_numero_romano' => 'Region Numero Romano',
			'region_descripcion' => 'Region Descripcion',
		);
	}
